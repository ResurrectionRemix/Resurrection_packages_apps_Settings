...
public class ChooseEncryptionPassword extends SettingsActivity {
    ...
    public static class ChooseEncryptionPasswordFragment extends InstrumentedFragment
        ...
        protected Intent getRedactionInterstitialIntent(Context context) {
            return RedactionInterstitial.createStartIntent(context, UserHandle.myUserId());
        }
            ...
            if (mUiStage == Stage.Introduction) {
                if (length < mPasswordMinLength) {
                    ...
                    if (error != null) {
                        ...
                        mHeaderText.setText(R.string.lockpassword_continue_label);
                        setNextEnabled(true);
                    }
                }
            } else {
        ...
        private void startSaveAndFinish() {
            ...
            mSaveAndFinishWorker.start(mLockPatternUtils, required, mHasChallenge, mChallenge,
                    mChosenPassword, mCurrentPassword, mRequestedQuality, UserHandle.myUserId());
        }
