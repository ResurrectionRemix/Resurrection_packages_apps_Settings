...
public class LCDDensityPreference extends CustomEditTextPreference {
    private static final String TAG = "LCDDensityPreference";

    public LCDDensityPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onAttached() {
        ...
        setSummary(getContext().getString(R.string.custom_density_summary, getCurrentSwDp()));
    }
