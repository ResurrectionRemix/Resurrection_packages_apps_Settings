...
public class AboutSettingsPreview extends LayoutPreference {
    ...
    private static final String TAG = "AboutSettingsPreview";

    public AboutSettingsPreview(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0 /* defStyleAttr */);
    }

    public AboutSettingsPreview(Context context, AttributeSet attrs, int defStyleAttr) {
