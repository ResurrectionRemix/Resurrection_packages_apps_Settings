...
import com.android.settings.rr.CustomAnims;
import com.android.settings.rr.DashBoardSettings;
import com.android.settings.rr.DeviceMaintainersFragment;
import com.android.settings.rr.fragments.*;
import com.android.settings.rr.gesture.GestureAnywhereSettings;
import com.android.settings.rr.HardwareKeys;
import com.android.settings.rr.HeadsUp;
import com.android.settings.rr.input.PowerMenuActions;
import com.android.settings.rr.Interface;
import com.android.settings.rr.LockSettings;
import com.android.settings.rr.LogoSettings;
import com.android.settings.rr.Misc;
import com.android.settings.rr.MiscInterfaceSettings;
import com.android.settings.rr.Navigation;
import com.android.settings.rr.navigation.fragments.*;
import com.android.settings.rr.NetworkTraffic;
import com.android.settings.rr.QsAdvanced;
import com.android.settings.rr.QsAnimations;
import com.android.settings.rr.QsLayout;
import com.android.settings.rr.QSMainSettings;
import com.android.settings.rr.QsPullDown;
import com.android.settings.rr.RecentsSettings;
import com.android.settings.rr.RecentsUI;
import com.android.settings.rr.rrdrill;
import com.android.settings.rr.ScreenShotSettings;
import com.android.settings.rr.StatusbarBatteryStyle;
import com.android.settings.rr.StatusBarGestures;
import com.android.settings.rr.StatusBarIcons;
import com.android.settings.rr.StatusBarSettings;
import com.android.settings.rr.StatusBarWeather;
import com.android.settings.rr.Ticker;
import com.android.settings.rr.ToastAnimations;
import com.android.settings.rr.VolumePanelSettings;
...
public class SearchIndexableResourcesImpl implements SearchIndexableResources {
    ...
    public SearchIndexableResourcesImpl() {
        ...
        addIndex(StatusBarGestures.class);
        addIndex(StatusBarIcons.class);
        addIndex(StatusBarSettings.class);
        addIndex(StatusBarWeather.class);
        addIndex(StatusbarBatteryStyle.class);
        addIndex(ScreenShotSettings.class);
        addIndex(LockSettings.class);
        addIndex(DashBoardSettings.class);
        addIndex(GestureAnywhereSettings.class);
        addIndex(RecentsUI.class);
        addIndex(QSMainSettings.class);
        ...
        addIndex(Navigation.class);
        addIndex(Interface.class);
        addIndex(QsPullDown.class);
        addIndex(ClockSettings.class);
        addIndex(CarrierLabel.class);
        addIndex(MiscInterfaceSettings.class);
        addIndex(PowerMenuActions.class);
        addIndex(QsLayout.class);
        addIndex(QsAnimations.class);
        addIndex(CustomAnims.class);
        addIndex(LogoSettings.class);
        addIndex(PanelSettingsNav.class);
        addIndex(MiscSettingsNav.class);
        addIndex(UISettingsNav.class);
        addIndex(StatusBarSettingsNav.class);
        ...
        addIndex(HardwareKeys.class);
        addIndex(Ticker.class);
        addIndex(QsAdvanced.class);
        addIndex(ToastAnimations.class);
