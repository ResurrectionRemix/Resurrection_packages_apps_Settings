...
package com.android.settings.pac.preference;
...
/**
 * A {@link DialogPreference} that provides a user with the means to select an integer from a {@linkNumberPicker}, and persist it.
 *
 * @author lukehorvat
 *
 */
