...
public class ScrollAnimationInterfaceSettings extends SettingsPreferenceFragment implements
    ...
    private NEWSeekBarPreference mAnimationFling;
    private NEWSeekBarPreference mAnimationScroll;
    private NEWSeekBarPreference mAnimationOverScroll;
    private NEWSeekBarPreference mAnimationOverFling;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAnimationScroll = (NEWSeekBarPreference) prefSet.findPreference(ANIMATION_SCROLL_FRICTION);
        ...
        mAnimationFling = (NEWSeekBarPreference) prefSet.findPreference(ANIMATION_FLING_VELOCITY);
        ...
        mAnimationOverScroll = (NEWSeekBarPreference) prefSet.findPreference(ANIMATION_OVERSCROLL_DISTANCE);
        ...
        mAnimationOverFling = (NEWSeekBarPreference) prefSet.findPreference(ANIMATION_OVERFLING_DISTANCE);
